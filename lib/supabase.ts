...
export type Category = { id: string; name: string; image_url: string | null };
...
export type CompatibilityGroup = { id: string; part_type: 'display' | 'battery' | 'other'; notes: string | null };
